...
def gravitational_force(mass1, mass2, distance):
    # TODO: Can make this more robust in the future by using distance as a vector.
    """
    Calculates the gravitational potential between two masses at some distance.
    
    :param mass1: scalar, mass in kg of first object
    :param mass2: scalar, mass in kg of second object
    :param distance: scalar, distance between two objects in meters
    
    :return force: scalar, Force of attraction between the objects in N
    """
